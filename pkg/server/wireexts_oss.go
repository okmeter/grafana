...
import (
	op_datasource_cache "github.com/grafana/grafana/op-pkg/service/cache/datasource"
)
...
var wireExtsBasicSet = wire.NewSet(
	...
	op_datasource_cache.ProvideCacheService,
	wire.Bind(new(datasources.CacheService), new(*op_datasource_cache.Service)),
	// original: datasourceservice.ProvideCacheService
	// original: wire.Bind(new(datasources.CacheService), new(*datasourceservice.CacheServiceImpl))
	// OP_CHANGES.md: use custom datasource cache service
