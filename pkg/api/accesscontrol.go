...
func (hs *HTTPServer) declareFixedRoles() error {
	...
	dashboardsReaderRole := ac.RoleRegistration{
		...
		// original: Grants: []string{"Admin"}
		// OP_CHANGES.md: grant read access for all Editors and Viewers by default
		Grants: []string{"Admin", "Editor", "Viewer"},
	}
	...
	dashboardsWriterRole := ac.RoleRegistration{
		...
		// original: Grants: []string{"Admin"}
		// OP_CHANGES.md: grant write access for all Editors by default
