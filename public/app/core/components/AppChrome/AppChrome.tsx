...
// OP_CHANGES.md: disable menu, search and navigation
// original:
...
export function AppChrome({ children }: Props) {
  ...
  // OP_CHANGES.md: disable menu, search and navigation
  // original: const searchBarHidden = state.searchBarHidden || state.kioskMode === KioskMode.TV;
    ...
    <main className="main-view">
      {!state.chromeless && (
        <div className={cx(styles.topNav)}>
          ...
          {/*/>*/}
          <div className={styles.actions}>{state.actions}</div>
        </div>
      )}
